...
class Parse{
    ...
    parseExpression(){
        let left = this.parseTerm(); //This i think calls the parseNumber method and stores it inside the variable left
        ...
        let right = this.parseTerm(); //Calls parseNumber and gets its return which is stored in the variable right
